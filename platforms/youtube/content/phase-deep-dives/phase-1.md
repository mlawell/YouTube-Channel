...
| Measure | Value |
| --- | --- |
| Straight line to the Town Center | 0.90 mi |
| Cart floor at 30 mph | 1.8 min |
| Straight line to Highway 79 | 0.17 mi |
...
`[FRAME phase-1]` · `PB 27/73 · 59 homesites · 34 acres`
...
> `[ON SCREEN: straight line 0.90 mi · floor 1.8 min at 30 mph]`

> Straight line it's 0.90 miles, so it could never be quicker than about 1.8 minutes — and roads aren't straight lines, so the real answer is `[CART]`.
...
> Highway 79 is **0.17 miles** from the middle of this phase in a straight line. `[ON SCREEN: 0.17 mi to Hwy 79]`
