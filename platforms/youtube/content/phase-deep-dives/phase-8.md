...
| By road to the Town Center | 4.1 mi |
...
> `[ON SCREEN: 4.1 mi by road · about 10 min on a cart]`

> So here's the question everybody actually asks: how far is it to the Town Center? By road it's about 4.1 miles, which is about a ten minute cart ride.
...
> And then the part that isn't on any map and isn't in any county record, which is why the two of us picked this one out of all ten.
...
- **LMWS Hang Loose Court** — Hang Loose Ct — one of Karen and Mike's own three Phase 8 streets
