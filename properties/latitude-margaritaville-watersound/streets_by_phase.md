...
**Lot numbers are not house numbers.** Two different number series exist and they are easy to confuse. MINTO LOT NUMBERS carry a phase prefix from Phase 4 onward (4xxx ... 10xxx), so a lot number identifies its phase; phases 1-3 use one unprefixed run of 1-381. COUNTY HOUSE NUMBERS -- the searchable street address -- are an entirely different series. On Escape Avenue, Minto lot 8042 is not house number 8042: the county address range on that street is 9201-9499 in Phase 7 and 9502-9667 in Phase 8. Quote house numbers to buyers, not lot numbers.

> Illustrative only - not a survey. Street names are transcribed from
> county records, never invented or inferred. Where the county has no
> coverage the entry is left blank and flagged rather than guessed.

## Streets that cross a phase boundary

These are the ones that catch buyers out: two homes on the same street,
two different phases. Where the county has house numbers on both sides,
the address range tells you which phase you are looking at.
...
`LATITUDE AT WATERSOUND AREA 1 PH 1` - plat book 27, page 73
...
`LATITUDE AT WATERSOUND AREA 1 PH 2` - plat book 28, page 8
...
`LATITUDE AT WATERSOUND AREA 1 PH 3A` - plat book 28, page 34
...
`LATITUDE AT WATERSOUND AREA 1 PH 3B & 3C` - plat book 28, page 63
...
`LATITUDE AT WATERSOUND AREA 1 PH 3D` - plat book 30, page 8
...
`LATITUDE AT WATERSOUND AREA 1 PH 4A` - plat book 29, page 23
...
`LATITUDE AT WATERSOUND AREA 1 PH 4B` - plat book 29, page 76
...
`LATITUDE AT WATERSOUND AREA 1 PHASE 5B` - plat book 30, page 14
...
`LATITUDE AT WATERSOUND AREA 1 PHASE 5C` - plat book 30, page 27
...
`LATITUDE AT WATERSOUND AREA 1 PHASE  6A` - plat book 30, page 39
...
`LATITUDE AT WATERSOUND AREA 1 PHASE  6B & 6C` - plat book 30, page 80
...
`LATITUDE AT WATERSOUND AREA 1 PHASE 7` - plat book 31, page 14
...
`LATITUDE AT WATERSOUND AREA 1 PHASE 8` - plat book 31, page 71
...
`LATITUDE AT WATERSOUND AREA 1 PHASE 9` - plat book 33, page 57
...
`LATITUDE AT WATERSOUND AREA 1 PHASE 10` - plat book 33, page 98
